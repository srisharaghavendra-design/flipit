...
export default async function handler(req, res) {
  ...
  const depthSections = depths.map(d => {
    ...
    if (d === "2") return `"specComparison":{"tableRows":[{"feature":"<real differentiating feature>","ours":"<precise spec for ${isFlip?competitor:product}>","theirs":"<precise spec for ${isFlip?product:competitor}>","advantage":"<clear winner and why it matters in this deal>"},{"feature":"<real feature>","ours":"<real spec>","theirs":"<real spec>","advantage":"<winner>"},{"feature":"<real feature>","ours":"<real spec>","theirs":"<real spec>","advantage":"<winner>"},{"feature":"<real feature>","ours":"<real spec>","theirs":"<real spec>","advantage":"<winner>"},{"feature":"<real feature>","ours":"<real spec>","theirs":"<real spec>","advantage":"<winner>"}]}`;
